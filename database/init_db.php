...
try {
    ...
    if ($stmt->fetchColumn() == 0) {
        ...
        $insert = $db->prepare("INSERT INTO users (username, password, role) VALUES ('admin', :pass, 'administrador')");
        $insert->execute(['pass' => $password]);
        echo "Usuario administrador creado (Usuario: admin | Contraseña: admin123 | Rol: administrador).\n";
    }
