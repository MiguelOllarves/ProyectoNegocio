...
**TuInventario** es un sistema minimalista, extremadamente rápido y autogestionable, diseñado específicamente para controlar inventarios, puntos de venta (POS) y métricas contables. Cuenta con un fuerte enfoque práctico para comercios, soportando un entorno de **múltiples divisas (USD, VES, EUR, COP)**, adaptabilidad fiscal (Cálculos de IVA e IGTF automatizados), y lectura de tasas en tiempo real. 
